...
describe("Profiles Use cases tests", () => {
    ...
    beforeEach(() => {
        ...
        createHandler = new CreateProfileCommandHandler(repo, ProfilesFactory, service);
    ...
    test("Should update profile", async () => {
        await createHandler.handle({ userId: 1, phone: "+380991112233", bio: "Old" });
        const updateHandler = new UpdateProfileCommandHandler(repo, service);

        const result = await updateHandler.handle({
            id: 1,
            phone: "+380997778899",
            bio: "Updated bio"
        });
    ...
    test("Should delete profile", async () => {
        await createHandler.handle({ userId: 1, phone: "+380991112233", bio: "To delete" });
